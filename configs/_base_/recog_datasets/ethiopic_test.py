...
test_root = '/home/xwang/mmocr/datasets/test'

test_img_prefix1 = f'{test_root}/ABE_test/test_images/'
test_img_prefix2 = f'{test_root}/ART_test/test_images/'
...
test_ann_file1 = f'{test_root}/ABE_test/ABE_test.txt'
test_ann_file2 = f'{test_root}/ART_test/ART_test.txt'
